...
public class ClasseDAO {
    ...
    public static Classes getClasse(int classeId) {
        try {
            ...
            if (resultSet.next()) {
                classe.setClassesId(resultSet.getInt(CLASS_ID));
                classe.setClassesName(resultSet.getString(CLASS_NAME));
            }
            return classe;
    ...
    public static List<Classes> getAvailableClassesForLesson(int lessonId) {
        ...
        try {
            ...
            while (resultSet.next()) {
                ...
                classe.setClassesId(classId);
                classe.setClassesName(className);
