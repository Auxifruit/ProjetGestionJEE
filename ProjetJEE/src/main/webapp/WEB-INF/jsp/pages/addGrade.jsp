...
<div class="container">
  ...
  <!-- Teacher -->
  <%
    Integer teacherID = (Integer) request.getAttribute("teacherID"); // get TeacherID
    if (teacherID != null) {
      // get info from the ID
      Users teacher = UserDAO.getUserById(teacherID);
      if (teacher != null) {
  %>
  <h2>Professeur: <%= teacher.getUserName() %> <%= teacher.getUserLastName() %></h2>
  <%
      }
    }
  %>
